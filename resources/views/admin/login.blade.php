...
<head>
    ...
    <title>HK Decoration | Masuk</title>
...
<body class="text-center py-0">
    <div class="row w-100 m-0 h-100">
        <div class="col d-none d-lg-block px-0">
            <img src="{{asset('images/header2.jpg')}}" class="w-100 h-100" style="object-fit: cover;" alt="">
        </div>
        <div class="col mt-auto mb-auto">
            <main class="form-signin" style="max-width: 330px;">
                <form action="" method="post">
                    ...
                    <p class="mb-3 fw-normal">Login administrator</p>
