@extends('admin.layouts.master', ['title' => 'Paket sesi'])
@section('title')
Paket Sesi
@endsection
@section('style')
...
<div class="col-lg-12">
    <table id="table-session-package" class="table w-100">
        <thead>
            <tr>
                <th class="col-lg-3 d-none d-lg-table-cell ">Nama dekorasi</th>
                <th class="col-lg d-none d-lg-table-cell">Keterangan</th>
                <th class="col-lg-2 d-none d-lg-table-cell">Harga</th>
                <th class="col-lg d-none d-lg-table-cell">Aksi</th>
            </tr>
        </thead>
        <tbody>
            @foreach($sessionpackages->get() as $sessionpackage)
            <tr class="align-middle">
                <td class="col-12 col-lg-3 d-lg-table-cell">
                    <div class="d-none d-lg-flex align-items-center">
                        <img src="{{asset('storage/' . $sessionpackage->gambar)}}" class="rounded" alt="Gambar" style="width: 70px; height: 70px; object-fit:cover">
                        <div class="ms-2">{{$sessionpackage->nama}}</div>
                    </div>
                    <div class="d-lg-none">
                        <div class="d-flex">
                            <div class="me-3">
                                <img src="{{asset('storage/' . $sessionpackage->gambar)}}" alt="Gambar" class="rounded" style="width: 120px; height: 120px; object-fit:cover">
                            </div>
                            <div class="d-flex flex-column justify-content-center">
                                <small>Harga: </small>
                                <p class="mb-0 text-truncate">@currency($sessionpackage->harga)</p>
                                <small>Nama: </small>
                                <h6 class="mb-0">{{$sessionpackage->nama}}</h6>
                            </div>
                        </div>
                        <div class="d-flex justify-content-end">
                            <button class="btn btn-danger btn-sm me-2"></span><i class="fa fa-trash"></i></button>
                            <button decor-id="{{$sessionpackage->id}}" class="btn-update btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#detailDecoration"><i class="fa fa-edit"></i></span></button>
                        </div>
                    </div>
                </td>
                <td class="d-none d-lg-table-cell">
                    <p class="block-ellipsis mb-0">{{strip_tags($sessionpackage->keterangan)}}</p>
                </td>
                <td class="d-none d-lg-table-cell">
                    @currency($sessionpackage->harga)
                </td>
                <td class="d-none d-lg-table-cell">
                    <form action="/admin/session-package/destroy" method="post">
                        @csrf
                        <div class="d-flex">
                            <input type="hidden" name="id" value="{{$sessionpackage->id}}">
                            ...
                            <button type="button" decor-id="{{$sessionpackage->id}}" class="btn-update btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#detailDecoration"><i class="fa fa-edit"></i></button>
                        </div>
                    </form>
                </td>
            </tr>
...
<div class="modal fade" id="addDecoration" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="addDecorationLabel" aria-hidden="true">
    <div class="modal-dialog" style="max-width: 720px;">
        <form action="/admin/session-package/store" method="post" enctype="multipart/form-data">
            @csrf
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <label for="addDecorImg" class="form-label">Tambah gambar produk</label>
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" name="harga" id="addDecorPrice" class="form-control form-control-sm">
                        </div>
                    </div>
...
<div class="modal fade" id="detailDecoration" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="detailDecorationLabel" aria-hidden="true">
    <div class="modal-dialog" style="max-width: 720px;">
        <form action="/admin/session-package/update" method="post" enctype="multipart/form-data">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-6">
                            <label class="form-label">Harga</label>
                            <input type="text" name="harga" id="detailDecorPrice" class="form-control form-control-sm">
                        </div>
                    </div>
                    <div class="row mt-1 mb-3">
                    </div>
...
<script>
    $(document).ready(function() {
        $('#table-session-package').DataTable();
    });
</script>
...
<script>
    $('.btn-update').click(function() {
        ...
        $.getJSON('/session-package/getdata?id=' + id, function(data) {
