@extends('admin.layouts.master', ['title' => 'Item tambahan'])
@section('style')
<style>
    .bd-placeholder-img {
        font-size: 1.125rem;
...
<div class="col-lg-12">
    <table id="table-decoration-item" class="table w-100">
        <thead>
            <tr>
            ...
            <tr class="align-middle">
                <td class="col-12 col-lg-3 d-lg-table-cell">
                    <div class="d-none d-lg-flex align-items-center">
                        <img src="{{asset('storage/' . $decoration->gambar)}}" alt="Gambar" class="rounded" style="width: 70px; height: 70px; object-fit:cover">
                        <div class="ms-2">{{$decoration->nama}}</div>
                    </div>
                    <div class="d-lg-none">
                        <div class="d-flex">
                            <img src="{{asset('storage/' . $decoration->gambar)}}" alt="Gambar" class="rounded me-3" style="width: 120px; height: 120px; object-fit:cover">
...
<script>
    $(document).ready(function() {
        $('#table-decoration-item').DataTable();
    });
</script>
