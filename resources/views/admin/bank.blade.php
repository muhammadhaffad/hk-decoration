@extends('admin.layouts.master', ['title' => 'Bank'])
@section('style')
<style>
    .bd-placeholder-img {
        font-size: 1.125rem;
...
<div class="col-lg-6">
    <div class="d-flex justify-content-end mb-3">
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addBank"><span data-feather="plus"></span>&plus; Tambah</button>
    </div>
            ...
            <tr>
                <td class="col-12">
                    ...
                    <div class="d-flex justify-content-end align-items-end">
                        ...
                        <button bank-id="{{$bank->id}}" class="btn-detail-bank btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#detailBank"><i class="fa fa-edit"></i></button>
                    </div>
                </td>
            </tr>
            @endforeach
