@extends('newadmin.layouts.master', ['title' => 'Paket sesi'])
@section('style')
<style>
    .bd-placeholder-img {
        font-size: 1.125rem;
...
<div class="row">
    <div class="col-lg-12">
        <table class="table">
            <thead>
                <tr>
                    <th class="col-lg d-none d-lg-table-cell ">Nama dekorasi</th>
            ...
            <tbody>
                ...
                <tr class="align-middle">
                    <td class="col-12 col-lg-4 d-lg-table-cell">
                        <div class="d-none d-lg-flex align-items-center">
                            <img src="{{asset('storage/' . $sessionpackage->gambar)}}" alt="Gambar" style="width: 100px; height: 100px; object-fit:cover">
                        ...
                        <div class="d-lg-none">
                            ...
                            <div class="block">
                                ...
                                <p class="block-ellipsis">
                                    {{strip_tags($sessionpackage->keterangan)}}
                                </p>
                            </div>
                            <div class="d-flex justify-content-end">
                                <button class="btn btn-danger btn-sm me-2"></span><i class="bi bi-trash"></i></button>
                                <button decor-id="{{$sessionpackage->id}}" class="btn-update btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#detailDecoration"><i class="bi bi-pencil-square"></i></span></button>
                            </div>
                        </div>
                    </td>
                    ...
                    <td class="d-none col-lg-2 d-lg-table-cell">
